...
"director", "title", "famous actor", and "date" and another being the data types 
it's sorted by, which in this case are "date" and "famous actor".
...
private:
	const std::string CLASSIC_DATA_TYPES [] = {"director","title","famous actor"
		,"date"};
